...
const longword errIsoInvalidDataSize
    = 0x00040000;                              // Bad Datasize passed to send/recv buffer is invalid
...
int S7API Cli_ReadArea(
    S7Object Client, int Area, int DBNumber, int Start, int Amount, int WordLen, void *pUsrData);
int S7API Cli_WriteArea(
    S7Object Client, int Area, int DBNumber, int Start, int Amount, int WordLen, void *pUsrData);
...
//  Async functions
//------------------------------------------------------------------------------
int S7API Cli_AsReadArea(
    S7Object Client, int Area, int DBNumber, int Start, int Amount, int WordLen, void *pUsrData);
int S7API Cli_AsWriteArea(
    S7Object Client, int Area, int DBNumber, int Start, int Amount, int WordLen, void *pUsrData);
...
typedef int(S7API *pfn_RWAreaCallBack)(
    void *usrPtr, int Sender, int Operation, PS7Tag PTag, void *pUsrData);
...
typedef void(S7API *pfn_ParRecvCallBack)(
    void *usrPtr, int opResult, longword R_ID, void *pData, int Size);
...
int S7API Par_StartTo(S7Object Partner,
...
int S7API
Par_CheckAsBRecvCompletion(S7Object Partner, int *opResult, longword *R_ID, void *pData, int *Size);
...
int S7API Par_GetStats(S7Object Partner,
                       longword *BytesSent,
                       longword *BytesRecv,
                       longword *SendErrors,
                       longword *RecvErrors);
